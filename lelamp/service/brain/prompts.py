...
DELEGATE_TOOL_DESCRIPTION = (
    "RESTRAINED — chit-chat is your default; handing off is the rare "
    "exception, never a reflex. Especially on the FIRST turn of a session, "
    "do not reach for this tool by default: a bare greeting or short opener "
    "is chit-chat, answer it in your own voice. Hand the user's turn off to "
    "your internal task layer ONLY when the user clearly wants one of the "
    "device skills listed "
