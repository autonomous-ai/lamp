...
class Emotion2VecPlusLargeRecognizer(AudioEmotionRecognizer):
    ...
    DEFAULT_MODEL_PATH: Path | None = RESOURCES_DIR / "emotion2vec_plus_large" / "emotion2vec.onnx"
    DEFAULT_LABELS_PATH: Path | None = RESOURCES_DIR / "emotion2vec_plus_large" / "labels.txt"
